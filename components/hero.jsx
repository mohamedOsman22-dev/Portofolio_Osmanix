...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen pt-24 md:pt-28 flex items-center justify-center text-left overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950"
    >
  ...
  Hi, I'm{" "}
  <span className="inline-block whitespace-nowrap bg-gradient-to-r from-purple-500 via-blue-500 to-cyan-400 bg-clip-text text-transparent animate-gradient">
    Mohamed&nbsp;Osman
  </span>
</h1>


          <div className={`text-lg sm:text-xl md:text-2xl ${TEXT_SECONDARY} mb-8 h-7 sm:h-8`}>
            I'm a{" "}
            <span ref={textRef} className={`${TEXT_PRIMARY} font-medium`} />
          </div>

          <p className={`max-w-xl ${TEXT_TERTIARY} mb-10 text-sm sm:text-base leading-7`}>
        ...
        <div className="flex-1 flex justify-center md:justify-end mt-12 md:mt-0">
          <div className="relative group">
            ...
            />
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-[28rem] md:h-[28rem] rounded-full overflow-hidden shadow-2xl ring-8 ring-purple-500/60 bg-gray-900">
              <img
                src="/profile.png"
                alt="Mohamed Osman"
                className="w-full h-full object-cover"
                style={{ filter: "brightness(0.97) contrast(1.08)", objectPosition: "center top" }}
              />
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
        <a href="#about" className="text-gray-400 hover:text-white transition-colors" aria-label="Scroll to about">
          <ArrowDown size={24} />
        </a>
      </div>
    </section>
